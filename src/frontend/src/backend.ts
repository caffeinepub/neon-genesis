...
import type { Category as _Category, InvestmentRating as _InvestmentRating, Post as _Post, UserProfile as _UserProfile, UserRole as _UserRole, VirtualPrototype as _VirtualPrototype, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addInvestmentRating(arg0: bigint, arg1: InvestmentRating): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addInvestmentRating(arg0, to_candid_InvestmentRating_n8(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async createPost(arg0: string, arg1: string, arg2: Category, arg3: VirtualPrototype | null): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.createPost(arg0, arg1, to_candid_Category_n12(this._uploadFile, this._downloadFile, arg2), to_candid_opt_n14(this._uploadFile, this._downloadFile, arg3));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getPostsByCategory(arg0: Category): Promise<Array<Post>> {
        if (this.processError) {
            try {
                const result = await this.actor.getPostsByCategory(to_candid_Category_n12(this._uploadFile, this._downloadFile, arg0));
                return from_candid_vec_n15(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_opt_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_VirtualPrototype]): VirtualPrototype | null {
...
function from_candid_opt_n24(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Post]): Post | null {
    return value.length === 0 ? null : from_candid_Post_n16(_uploadFile, _downloadFile, value[0]);
}
...
function from_candid_record_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    likeCount: bigint;
    redRubyCount: bigint;
    virtualPrototype: [] | [_VirtualPrototype];
    description: string;
    author: Principal;
    timestamp: bigint;
    category: _Category;
    ...
    return {
        id: value.id,
        blueSapphireCount: value.blueSapphireCount,
        title: value.title,
        likeCount: value.likeCount,
        redRubyCount: value.redRubyCount,
        virtualPrototype: record_opt_to_undefined(from_candid_opt_n18(_uploadFile, _downloadFile, value.virtualPrototype)),
        description: value.description,
        author: value.author,
        timestamp: value.timestamp,
        category: from_candid_Category_n19(_uploadFile, _downloadFile, value.category),
        diamondCount: value.diamondCount
    };
}
...
function from_candid_variant_n20(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    disasterRelated: null;
} | {
    sustainableInfrastructure: null;
} | {
    environmental: null;
}): Category {
    return "disasterRelated" in value ? Category.disasterRelated : "sustainableInfrastructure" in value ? Category.sustainableInfrastructure : "environmental" in value ? Category.environmental : value;
}
...
function to_candid_InvestmentRating_n8(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: InvestmentRating): _InvestmentRating {
...
function to_candid_opt_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: VirtualPrototype | null): [] | [_VirtualPrototype] {
...
function to_candid_variant_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Category): {
    ...
    return value == Category.disasterRelated ? {
        disasterRelated: null
    } : value == Category.sustainableInfrastructure ? {
        sustainableInfrastructure: null
    } : value == Category.environmental ? {
        environmental: null
    } : value;
}
function to_candid_variant_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: InvestmentRating): {
    diamond: null;
} | {
    blueSapphire: null;
} | {
    ...
    return value == InvestmentRating.diamond ? {
        diamond: null
    } : value == InvestmentRating.blueSapphire ? {
        blueSapphire: null
    } : value == InvestmentRating.redRuby ? {
        redRuby: null
    } : value;
}
