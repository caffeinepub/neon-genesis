...
export type Category = { 'disasterRelated' : null } |
...
export type InvestmentRating = { 'diamond' : null } |
  { 'blueSapphire' : null } |
  { 'redRuby' : null };
...
export interface _SERVICE {
  ...
  'addInvestmentRating' : ActorMethod<[bigint, InvestmentRating], undefined>,
  'assignCallerUserRole' : ActorMethod<[Principal, UserRole], undefined>,
  'createPost' : ActorMethod<
    [string, string, Category, [] | [VirtualPrototype]],
    bigint
  >,
